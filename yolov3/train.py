...
if __name__ == "__main__":
    ...
    if True:
        ...
        train_dataset   = YoloDataset(train_lines, input_shape, num_classes, train = True) #得到2007_train.txt
        val_dataset     = YoloDataset(val_lines, input_shape, num_classes, train = False) #得到2007_val.txt
        # 加载图片数据和标签数据
